    ...
    <form onSubmit={handleSubmit} className="w-full space-y-4">
      <div className="relative">
        ...
        <button
          type="submit"
          disabled={loading}
          className={`absolute right-2 top-2 bottom-2 bg-indigo-600 hover:bg-indigo-700 text-white font-medium rounded-full px-6 transition-all duration-200 transform active:scale-95 ${
